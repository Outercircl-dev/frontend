-- COMPREHENSIVE SECURITY FIX: Remove sensitive data from profiles table
...
-- 7. Add additional security triggers for monitoring access to sensitive data
CREATE TRIGGER log_profiles_access
  AFTER SELECT ON public.profiles
  FOR EACH STATEMENT EXECUTE FUNCTION public.log_sensitive_data_access();
...
-- 9. Create summary of security improvements
SELECT 
