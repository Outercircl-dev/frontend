-- SECURITY FIX: Protect Customer Email Addresses and Payment Data
...
BEGIN
  ...
  -- Validate session is recent (within last 30 minutes for sensitive operations)
  SELECT EXISTS (
...
-- Step 6: Create audit trigger for sensitive data access
...
CREATE TRIGGER audit_profiles_sensitive_access
  ...
  FOR EACH ROW EXECUTE FUNCTION audit_profiles_sensitive_access();
