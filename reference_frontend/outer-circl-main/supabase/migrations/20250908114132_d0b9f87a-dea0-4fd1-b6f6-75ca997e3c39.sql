...
-- Drop ALL problematic functions with CASCADE (including log_security_event_secure)
...
DROP FUNCTION IF EXISTS public.log_security_event_secure(text,text,uuid) CASCADE;
