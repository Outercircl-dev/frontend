-- Fix mobile navbar profile icon and implement unique username requirements
...
-- Add unique constraint on username (this will now work since all users have usernames)
ALTER TABLE public.profiles ADD CONSTRAINT profiles_username_unique UNIQUE (username);

-- Update the profiles table to make username not nullable (after setting defaults)
