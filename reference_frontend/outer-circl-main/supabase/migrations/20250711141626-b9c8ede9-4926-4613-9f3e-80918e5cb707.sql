-- Update the event validation function to include the new 'health-wellness' category
...
BEGIN
  ...
  -- Update category validation to include new 'health-wellness' category
  IF NEW.category IS NOT NULL AND NEW.category NOT IN (
    'social', 'education', 'sports', 'arts', 'technology', 
    'food', 'fitness', 'health-wellness', 'outdoors', 'networking', 'giving-back', 'other'
  ) THEN
