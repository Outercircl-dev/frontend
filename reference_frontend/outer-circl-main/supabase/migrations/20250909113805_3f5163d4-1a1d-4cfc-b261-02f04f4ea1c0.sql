-- Security Enhancement: Harden database functions with explicit search_path
-- Update existing functions to use explicit search_path for security

-- Update log_security_event_secure function
...
-- Update sanitize_html_input function
...
-- Update log_sensitive_access_simple function
...
BEGIN
  ...
  -- Get current request count for this endpoint and user
...
-- Update wants_email_notifications function
...
-- Update is_friends_with function
...
-- Update is_event_participant function  
...
-- Update is_subscription_admin function
...
-- Update is_subscription_member function
...
-- Update cleanup_unattended_saved_events function
...
BEGIN
  -- Remove saved events where user didn't attend the completed event
