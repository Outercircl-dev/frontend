-- Update can_view_profile function to return access level instead of boolean
-- and ensure authentication is required for all profile access
...
-- Create function to get limited profile data
CREATE OR REPLACE FUNCTION public.get_limited_profile_data(profile_id uuid)
RETURNS TABLE(
  id uuid,
  name text,
  username text,
