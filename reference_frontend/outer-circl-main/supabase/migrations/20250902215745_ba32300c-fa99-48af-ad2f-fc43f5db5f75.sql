-- Fix remaining ambiguous event_id references in critical functions

-- Fix the is_event_participant function - this is likely the culprit
...
-- Fix any other functions that might have ambiguous references
-- Check and fix can_view_event_details function
...
-- Fix check_user_rating_status function if it exists
...
-- Fix is_event_owner function if it exists
...
-- Also make sure the leave_event function has proper aliases
