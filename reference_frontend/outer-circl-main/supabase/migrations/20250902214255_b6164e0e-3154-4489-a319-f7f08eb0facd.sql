...
-- Drop and recreate functions to update parameter signatures
...
-- Recreate check_profile_access_rate_limit function
...
-- Recreate check_sensitive_data_permission function
...
-- Recreate user_can_view_event function
...
-- Recreate discover_events_secure function
...
-- Recreate get_user_invitations function
...
-- Recreate get_admin_invitations function
...
-- Recreate audit_sensitive_data_access function
...
-- Recreate check_suspicious_access_patterns function
...
-- Recreate audit_sensitive_access function
