...
import { Image, ImagePlus, Upload, Archive, Sparkles } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const EnhancedImageUploadSection: React.FC<EnhancedImageUploadSectionProps> = ({
  eventImage,
  onImageSelected,
  activityTitle = '',
  activityCategory = ''
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="md:col-span-2 flex flex-col gap-3">
          ...
          <Button 
            ...
            type="button"
          >
            <Archive className="h-4 w-4" /> Browse Images
          </Button>
      ...
      <Dialog open={openStockImagesDialog} onOpenChange={setOpenStockImagesDialog}>
        <DialogContent className="sm:max-w-[900px] max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Browse and select from our curated image collection
            </DialogDescription>
          </DialogHeader>
            ...
            {loadingUserPhotos ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-h-[400px] overflow-y-auto">
                {userPhotos.map((photo) => (
                  ...
                  >
                    <AspectRatio ratio={1/1} className="rounded-xl overflow-hidden border-2 hover:border-pink-500 transition-all">
                      <LazyImage 
                    ...
                    <div className="absolute inset-0 flex items-end p-2 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl">
