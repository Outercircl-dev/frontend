...
const PRIVACY_POLICY_CONTENT = String.raw`OUTERCIRCL
Privacy Policy
...
This summary provides key points from our Privacy Notice. You can find full details by reviewing the relevant section below.
...
8. Our Data Compliance Model (Authentication, Profile Data & Payments)
...
We may provide you with the option to register using your existing social media account details (such as Google, Facebook, or X). If you choose to register this way, we will collect certain profile information from the social media provider. See Section 7 — 'How Do We Handle Your Social Logins?' — for more detail.
...
Google API
Our use of information received from Google APIs will adhere to the Google API Services User Data Policy, including the Limited Use requirements. See: developers.google.com/terms/api-services-user-data-policy
...
6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
In Short: We may use cookies and other tracking technologies to collect and store your information, in compliance with the GDPR and the Irish ePrivacy Regulations 2011 (S.I. No. 336 of 2011).
...
PostHog Analytics
We use PostHog EU Cloud (hosted in Frankfurt, Germany) to collect and analyse platform usage data. The following privacy measures are in place:
...
8.2 Onboarding and Profile Data
Data collected through onboarding forms and profile setup is collected for the sole purpose of providing the Outercircl service.
...
All payment information is processed by Stripe, Inc., which acts as an independent data processor and regulated payment service provider.
...
9. DO WE TRANSFER YOUR DATA INTERNATIONALLY?
In Short: We may transfer, store, and process your information in countries other than your own, with appropriate safeguards in place.
...
12. DO WE COLLECT INFORMATION FROM MINORS?
In Short: We do not knowingly collect data from or market to children under 16 years of age. The digital age of consent in Ireland is 16 under the Data Protection Act 2018.
...
Phone: +353 (0)1 765 0100 | Website: www.dataprotection.ie
