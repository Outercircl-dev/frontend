...
Nothing in these Terms is intended to exclude or limit any rights you may have under mandatory consumer or data protection laws in your country of residence.


1. DEFINITIONS AND TERMINOLOGY
Throughout these Terms, the following definitions apply. Understanding these terms is important as they define the scope of the Company's role, your rights and obligations, and the limits of the Company's liability.
1.1  Platform Terminology - Events
The following terms are used interchangeably throughout these Terms and across the Platform, and all refer to the same concept - a gathering, activity, or community group created and managed by a user:
...
Where these Terms refer to 'User Events,' that term encompasses all of the above. The use of different terminology on different parts of the Platform is for user experience purposes only and does not alter the legal rights or obligations set out in these Terms.
1.2  Key Parties
...
You must be at least 18 years old and capable of entering into a binding contract to use the Platform. You are responsible for:
...
4. ROLE OF THE PLATFORM - NEUTRAL INTERMEDIARY
THE PLATFORM IS A NEUTRAL TECHNOLOGY INTERMEDIARY ONLY.
Our role is limited to providing the software infrastructure that enables users to create, list, discover, and join User Events. The Company does not operate as an event organizer, promoter, venue operator, activity provider, employer, principal, or agent in connection with any User Event.
4.1  All Events Are User-Generated and User-Managed
Every User Event - whether referred to as a Cirql, Meetup, Activity, Group, or by any other name - is created, organized, managed, operated, and hosted entirely by Hosts, not by the Company. This applies regardless of whether the User Event is free or paid, one-off or recurring, held in a public space or private venue, open to all users or restricted to a specific community, or whether the Company provides technical tools to facilitate the event's creation or promotion.
THE COMPANY HAS NO INVOLVEMENT IN THE PLANNING, ORGANIZATION, OPERATION, SUPERVISION, STAFFING, SAFETY MANAGEMENT, INSURANCE ARRANGEMENTS, OR CANCELLATION OF ANY USER EVENT.
The mere fact that a User Event is listed, promoted, or accessible through the Platform does not imply any Company involvement, endorsement, approval, sponsorship, or assumption of responsibility.
4.2  Hosts Act Independently - No Agency Relationship
...
4.3  No Endorsement or Guarantee
The Company does not endorse, verify, approve, certify, or guarantee any User Event, Host, Participant, venue, activity, or outcome. The Company makes no representations or warranties regarding the accuracy of any event listing, the qualifications or character of any Host or Participant, the safety or legality of any User Event, or whether any User Event will take place as described, or at all.


5. USER-GENERATED CONTENT, FRAUD ADVISORY, AND PLATFORM SAFETY
5.1  User Responsibility for Content and Events
...
5.2  Prohibition on Fraudulent, False, or Misleading Listings
You must not create or promote any User Event listing that is false, fraudulent, misleading, deceptive, or materially inaccurate. Without limiting the foregoing, you must not:
...
Any breach of this section may result in immediate account termination, reporting to relevant law enforcement authorities, and civil legal action by affected users or the Company. The Company expressly disclaims all liability for any loss suffered by a Participant as a result of a fraudulent, false, or misleading User Event listing created by a Host.
5.3  Fraud Advisory - User Guidance and Reporting
The Company takes platform safety seriously and makes reasonable efforts to identify and remove fraudulent, suspicious, or harmful User Event listings. However, given the open and user-generated nature of the Platform, the Company cannot guarantee that all fraudulent activity will be detected, prevented, or removed in a timely manner.
IMPORTANT SAFETY NOTICE: The Company strongly advises all users to exercise caution and use their best judgment when interacting with other users, viewing event listings, and making any payments in connection with User Events.
When assessing the legitimacy of a User Event or Host, the Company recommends that users:
...
We do not have any obligation to monitor, review, moderate, or verify User Content or User Events. We may, entirely at our discretion, remove content or events, or suspend or terminate accounts, where we reasonably believe these Terms, our policies, or applicable law are violated - but this discretion does not create any duty to do so, and our failure to act does not constitute endorsement or approval of any User Content or User Event.
5.5  Company Not Liable for User Content or User Events
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE COMPANY IS NOT RESPONSIBLE FOR AND EXPRESSLY DISCLAIMS ALL LIABILITY IN CONNECTION WITH:
...
6. EVENT CANCELLATIONS, OFF-PLATFORM PAYMENTS, AND USER DISPUTES
6.1  Unexpected Event Cancellation
User Events may be cancelled, postponed, rescheduled, or materially altered at any time and for any reason by the Host, without prior notice to the Company or to Participants. Reasons for cancellation may include, without limitation: the Host's personal circumstances; insufficient attendance or registrations; venue unavailability; weather or environmental conditions; force majeure events affecting the Host; or any other reason at the Host's sole discretion.
THE COMPANY HAS NO CONTROL OVER AND ACCEPTS NO RESPONSIBILITY FOR THE CANCELLATION, POSTPONEMENT, RESCHEDULING, OR MATERIAL ALTERATION OF ANY USER EVENT BY A HOST. THE COMPANY DOES NOT GUARANTEE THAT ANY USER EVENT WILL TAKE PLACE AS LISTED, AT THE STATED TIME OR LOCATION, OR AT ALL.
...
In the event of a cancellation or material alteration, Participants should contact the Host directly. Where a Participant has made a payment for the cancelled or altered event, the provisions of Section 6.2 apply.
6.2  Host Cancellation and Refund Responsibility
Where a Host collects payment from Participants in connection with a User Event - whether through the Platform Payment System or by any other means - and the Host subsequently cancels, postpones, materially alters, or fails to deliver the User Event as described, any obligation to issue a refund to Participants rests solely and exclusively with the Host, not with the Company.
THE COMPANY IS NOT RESPONSIBLE FOR AND WILL NOT PROVIDE REFUNDS IN RESPECT OF ANY PAYMENT MADE BY A PARTICIPANT TO A HOST FOR A USER EVENT, REGARDLESS OF WHETHER THAT EVENT WAS CANCELLED, POSTPONED, ALTERED, NOT DELIVERED AS DESCRIBED, OR FRAUDULENTLY LISTED.
Participants who have paid a Host for a User Event that has been cancelled or not delivered should:
...
The Company may, entirely at its discretion, assist in facilitating communication between Hosts and Participants in connection with a dispute, but has no obligation to do so and any such assistance does not constitute an assumption of liability by the Company.
6.3  Off-Platform Payments - Warning and Disclaimer
WARNING: THE COMPANY STRONGLY ADVISES ALL USERS NOT TO MAKE OR ACCEPT ANY PAYMENT IN CONNECTION WITH A USER EVENT OUTSIDE OF THE PLATFORM PAYMENT SYSTEM.
The Platform Payment System - provided exclusively through Stripe Connect - is the only payment channel through which the Company can offer any form of payment record, dispute facilitation, or chargeback pathway in connection with User Events. Payments made outside of the Platform Payment System ('Off-Platform Payments') are made entirely at the user's own risk.
Off-Platform Payments include, without limitation: cash payments; bank transfers; payments via third-party apps (including PayPal, Venmo, Revolut, Cash App, or similar services); cryptocurrency transfers; cheques; or any other payment method not processed through the Platform's integrated Stripe Connect infrastructure.
The Company strongly advises that:
...
By using the Platform, you agree to attempt to resolve any payment dispute directly with the relevant Host before initiating a chargeback or payment reversal with your bank or card issuer. You acknowledge that:
...
6.5  User-to-User Disputes - No Company Obligation
The Company is not a party to any agreement, transaction, or dispute between users - including between Hosts and Participants, between two or more Hosts, or between any users in connection with any User Event. The Company has no obligation whatsoever to:
...
IN THE EVENT OF A DISPUTE BETWEEN USERS, THE COMPANY'S SOLE DISCRETIONARY ACTION MAY BE TO REMOVE CONTENT, RESTRICT FEATURES, OR SUSPEND OR TERMINATE ACCOUNTS WHERE WE REASONABLY BELIEVE THESE TERMS OR APPLICABLE LAW ARE VIOLATED. THE COMPANY WILL NOT TAKE SIDES IN ANY USER DISPUTE AND MAKES NO DETERMINATION OF FAULT OR LIABILITY AS BETWEEN USERS. ANY ACTION TAKEN OR NOT TAKEN BY THE COMPANY IN RESPONSE TO A USER DISPUTE DOES NOT CREATE LIABILITY ON THE PART OF THE COMPANY AND DOES NOT CONSTITUTE AN ENDORSEMENT OF EITHER PARTY'S POSITION.
Users are solely responsible for resolving their own disputes, including through direct negotiation, independent mediation, or legal proceedings in the appropriate jurisdiction. The Company encourages users to seek independent legal advice where a dispute is significant or unresolved.


7. INSURANCE - HOST AND PARTICIPANT OBLIGATIONS
7.1  Company Provides No Insurance
THE COMPANY DOES NOT PROVIDE, ARRANGE, PROCURE, UNDERWRITE, OR MAINTAIN ANY FORM OF INSURANCE COVERAGE FOR ANY USER EVENT, CIRQL, MEETUP, ACTIVITY, OR GROUP, OR FOR ANY HOST, PARTICIPANT, OR THIRD PARTY IN CONNECTION THEREWITH.
The Company is not an insurer, insurance broker, or insurance intermediary. Nothing in these Terms, on the Platform, or in any communications from the Company constitutes advice or a recommendation in relation to any specific insurance product or provider.
7.2  Host Insurance Obligations
AS A HOST, YOU ARE SOLELY AND EXCLUSIVELY RESPONSIBLE FOR DETERMINING, OBTAINING, AND MAINTAINING ALL INSURANCE COVERAGE THAT IS APPROPRIATE, NECESSARY, OR LEGALLY REQUIRED FOR YOUR USER EVENT.
This responsibility applies to all User Events, including single one-off meetups, recurring circls, ongoing groups, structured activity programmes, paid and free events, and events held in any location. The Company strongly recommends that all Hosts obtain, at a minimum:
...
These recommendations are general guidance only and do not constitute legal or insurance advice.
7.3  Recurring Events and Ongoing Circls - Heightened Recommendation
The Company particularly and strongly recommends that Hosts who organize recurring User Events, ongoing Circls, regular group activities, or structured activity programmes obtain and maintain continuous Public Liability Insurance for the full duration of their activity. The cumulative, ongoing nature of recurring events means the probability of an incident increases over time. You acknowledge it is your sole responsibility to obtain, maintain, and update your insurance coverage throughout the life of your activity.
7.4  Participant Insurance Responsibility
AS A PARTICIPANT, YOU ARE SOLELY RESPONSIBLE FOR DETERMINING WHETHER YOU REQUIRE ANY PERSONAL INSURANCE COVERAGE BEFORE ATTENDING ANY USER EVENT.
By attending any User Event, you acknowledge that the Host may or may not hold Public Liability Insurance, the Company does not verify whether any Host holds any insurance, and the Company does not warrant that any Host's insurance will cover your specific claim.
7.5  Company Not Liable for Insurance Failures
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE COMPANY EXPRESSLY DISCLAIMS ALL LIABILITY ARISING FROM ANY FAILURE BY A HOST TO OBTAIN, MAINTAIN, OR RENEW ANY INSURANCE POLICY, ANY REFUSAL BY AN INSURER TO PAY OUT ON A CLAIM, OR ANY CLAIM THAT IS UNINSURED OR UNDERINSURED AS A RESULT OF A HOST'S FAILURE TO OBTAIN ADEQUATE COVERAGE.
The Company's recommendation that Hosts obtain Public Liability Insurance does not create any legal obligation on the Company to ensure, verify, or enforce such coverage.


8. IN-PERSON EVENTS, ASSUMPTION OF RISK, AND RELEASE
8.1  Inherent Risks
You understand and acknowledge that attending, hosting, or participating in in-person User Events involves inherent risks that cannot be fully eliminated, including the risk of illness, personal injury, disability, permanent harm, death, and property damage. These risks exist regardless of whether the User Event takes place in a public space, private venue, or any other location.
8.2  Voluntary Assumption of Risk
You choose to attend, host, or participate in any User Event entirely at your own discretion and risk. To the maximum extent permitted by applicable law, you voluntarily and knowingly assume all risks arising out of or related to your attendance at, participation in, or organization of any User Event, including risks arising from the physical nature of any activity; the conduct of other Participants, Hosts, or third parties; the venue, location, or environment; the presence of alcohol or other substances at a User Event; the absence of adequate insurance coverage by the Host; and travel to and from any User Event.
8.3  Release of Company
TO THE MAXIMUM EXTENT PERMITTED BY THE LAW OF THE STATE OR COUNTRY WHERE THE EVENT TAKES PLACE, YOU RELEASE, WAIVE, DISCHARGE, AND COVENANT NOT TO SUE THE COMPANY AND ITS OFFICERS, DIRECTORS, EMPLOYEES, CONTRACTORS, AND AGENTS FROM ANY AND ALL CLAIMS, DEMANDS, CAUSES OF ACTION, DAMAGES, LOSSES, COSTS, OR EXPENSES OF ANY KIND, KNOWN OR UNKNOWN, ARISING OUT OF OR IN ANY WAY CONNECTED WITH YOUR PARTICIPATION IN OR ORGANIZATION OF ANY USER EVENT, YOUR INTERACTIONS WITH OTHER USERS OR THIRD PARTIES, THE ABSENCE OF OR FAILURE IN ANY INSURANCE COVERAGE, OR YOUR TRAVEL TO OR FROM ANY USER EVENT, EXCEPT TO THE EXTENT CAUSED DIRECTLY AND SOLELY BY A COMPANY-SPONSORED EVENT EXPRESSLY DESIGNATED AS SUCH IN WRITING BY THE COMPANY.
This Section does not exclude or limit any liability that cannot be excluded or waived under mandatory applicable law.
8.4  Dangerous, High-Risk, and Licensed Activities
Certain User Events may involve activities that carry a heightened risk of injury or death, or that may require professional supervision, permits, licences, or specialist training ('High-Risk Activities'), including without limitation: water sports, extreme sports, contact sports, climbing, cycling, equestrian activities, activities involving firearms or sharp implements, and any activity requiring a professional instructor or safety officer.
THE COMPANY MAKES NO REPRESENTATION THAT ANY ACTIVITY LISTED ON THE PLATFORM IS SAFE, APPROPRIATELY SUPERVISED, PROPERLY LICENSED, OR SUITABLE FOR PARTICIPATION BY ANY PARTICULAR INDIVIDUAL. HOSTS ARE SOLELY RESPONSIBLE FOR ENSURING THAT ANY HIGH-RISK ACTIVITY COMPLIES WITH ALL APPLICABLE SAFETY LAWS, LICENSING REQUIREMENTS, AND PROFESSIONAL STANDARDS. PARTICIPANTS ARE SOLELY RESPONSIBLE FOR ASSESSING THEIR OWN FITNESS AND CAPABILITY BEFORE PARTICIPATING IN ANY ACTIVITY.
8.5  Alcohol and Controlled Substances
THE COMPANY IS NOT RESPONSIBLE FOR AND EXPRESSLY DISCLAIMS ALL LIABILITY FOR ANY HARM, INJURY, DEATH, PROPERTY DAMAGE, OR OTHER LOSS ARISING FROM OR RELATED TO THE CONSUMPTION OR PRESENCE OF ALCOHOL OR ANY CONTROLLED SUBSTANCE AT ANY USER EVENT.
Hosts are solely responsible for complying with all applicable alcohol licensing laws, age verification requirements, and duty of care obligations. Hosts must not permit the consumption of unlawfully obtained controlled substances at any User Event. Any User Event involving unlawful drug use may result in immediate account termination and reporting to law enforcement.
8.6  Accessibility and Disability Accommodation
THE COMPANY IS NOT RESPONSIBLE FOR AND EXPRESSLY DISCLAIMS ALL LIABILITY FOR ANY FAILURE BY A HOST OR VENUE OPERATOR TO PROVIDE ACCESSIBLE FACILITIES OR REASONABLE ACCOMMODATIONS FOR PERSONS WITH DISABILITIES AT ANY USER EVENT.
Participants with accessibility requirements are advised to contact the Host directly before attending any User Event. Hosts are solely responsible for ensuring their User Events comply with all applicable disability and accessibility laws.
8.7  Minors
HOSTS MUST NOT PERMIT PERSONS UNDER THE AGE OF 18 TO REGISTER FOR OR ATTEND ANY USER EVENT ORGANIZED THROUGH THE PLATFORM UNLESS THE HOST HAS OBTAINED ALL LEGALLY REQUIRED PARENTAL OR GUARDIAN CONSENTS AND COMPLIED WITH ALL APPLICABLE CHILD PROTECTION LAWS. THE COMPANY IS NOT RESPONSIBLE FOR AND EXPRESSLY DISCLAIMS ALL LIABILITY FOR ANY HARM SUFFERED BY A MINOR IN CONNECTION WITH ANY USER EVENT.
8.8  No Background Checks
THE COMPANY DOES NOT CONDUCT BACKGROUND CHECKS, IDENTITY VERIFICATION, CRIMINAL RECORD CHECKS, INSURANCE VERIFICATION, OR ANY OTHER SCREENING OF HOSTS OR PARTICIPANTS.
You are solely responsible for exercising your own judgment and taking appropriate precautions when interacting with other users or attending User Events.


9. GENDER-SPECIFIC, IDENTITY-BASED, AND COMMUNITY EVENTS
9.1  User-Created Community and Identity-Based Events
The Platform supports diverse communities, including those organized around shared identities or personal characteristics. Hosts may create User Events designed for or limited to specific communities, including events for women, non-binary people, specific racial or ethnic communities, specific religious communities, specific sexual orientations, or people with specific disabilities or health conditions. The existence of such events does not constitute endorsement by the Company.
9.2  Host Is Solely Responsible for Legal Compliance
HOSTS ARE SOLELY AND EXCLUSIVELY RESPONSIBLE FOR ENSURING THAT THE ELIGIBILITY CRITERIA, ADMISSION POLICIES, AND OPERATION OF THEIR USER EVENTS COMPLY WITH ALL APPLICABLE LAWS IN THE JURISDICTION WHERE THE EVENT TAKES PLACE,
...
9.3  Company Not Liable for Host Decisions on Event Composition
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE COMPANY EXPRESSLY DISCLAIMS ALL LIABILITY IN CONNECTION WITH ANY DECISION BY A HOST TO RESTRICT OR DEFINE PARTICIPATION IN A USER EVENT BASED ON GENDER, GENDER IDENTITY, SEXUAL ORIENTATION, RACE, ETHNICITY, RELIGION, DISABILITY, OR ANY OTHER PERSONAL CHARACTERISTIC, AND ANY CLAIM OR LEGAL ACTION ARISING THEREFROM.
9.4  Company's Right to Remove Non-Compliant Events
The Company reserves the right, but not the obligation, to remove, restrict, or refuse to list any User Event, or to suspend or terminate any account, where the Company reasonably believes the event or its eligibility criteria may violate applicable law, our policies, or these Terms.
9.5  Indemnification for Identity-Based Event Claims
In addition to the general indemnification in Section 18, you agree to indemnify and hold harmless the Company from any and all claims, costs, fines, and legal fees arising from any User Event you host that restricts participation based on any personal characteristic, or any allegation that such criteria violate applicable anti-discrimination or equality law.


10. PAYMENTS, TOP-UPS, AND STRIPE CONNECT
10.1  Payment Processing via Stripe Connect
...
We are the owner or the licensee of all intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics (collectively, the 'Content'), as well as the trademarks, service marks, and logos (the 'Marks'). Our Content and Marks are protected by copyright and trademark laws in Ireland, the United States, and around the world.
Your Use of Our Services
Subject to your compliance with these Legal Terms, we grant you a non-exclusive, non-transferable, revocable licence to access the Services for your personal, non-commercial use or internal business purpose only. No part of the Services and no Content or Marks may be commercially exploited without our express prior written permission. Any breach will result in immediate termination of your licence.
Reviews and Ratings - Disclaimer
Reviews represent the personal opinions of individual users and do not represent the views of the Company. The Company does not endorse, verify, or guarantee the accuracy of any Review.
THE COMPANY IS NOT RESPONSIBLE FOR AND EXPRESSLY DISCLAIMS ALL LIABILITY FOR ANY REVIEW POSTED BY A USER, INCLUDING ANY REVIEW THAT IS FALSE, INACCURATE, DEFAMATORY, OR OTHERWISE UNLAWFUL. THE COMPANY'S LIABILITY FOR ANY REVIEW IS LIMITED TO REMOVING THE REVIEW WHERE WE DETERMINE, IN OUR SOLE DISCRETION, THAT REMOVAL IS APPROPRIATE.
Your Submissions and Contributions
By directly sending us any Submissions, you agree to assign to us all intellectual property rights in such Submission. By posting Contributions through the Services, you automatically grant us an unrestricted, irrevocable, perpetual, royalty-free, worldwide licence to use, reproduce, distribute, and exploit such Contributions for any purpose. You retain ownership of your Contributions but are solely responsible for them.


12. COMMUNITY STANDARDS AND NON-DISCRIMINATION
Users must comply with all applicable anti-discrimination, equality, and harassment laws when using the Platform and when organizing or attending User Events of any kind. You may not organize, promote, or participate in events that unlawfully discriminate against or harass any person based on gender, gender identity or expression, sexual orientation, race, ethnicity, religion, disability, or any other protected characteristic. See Section 9 for the specific treatment of identity-based events and the allocation of legal responsibility in connection with them.
We may remove any User Content or User Event, or suspend or terminate accounts, that we believe violate these standards or applicable law.


13. SUBSCRIPTIONS, MEMBERSHIPS, AND REFUNDS
13.1  Billing and Renewal
Your subscription will continue and automatically renew unless cancelled. You consent to our charging your payment method on a recurring basis without requiring your prior approval for each recurring charge, until such time as you cancel. All charges are processed through Stripe Connect in accordance with Section 10.
13.2  Free Trial
We may offer a free trial to new users. The subscription will automatically convert to a paid subscription at the end of the free trial unless you cancel before the trial period ends. We reserve the right to modify, shorten, or discontinue free trial offers at any time without notice or liability.
13.3  All Fees Are Non-Refundable - No Exceptions
ALL FEES, SUBSCRIPTION CHARGES, TOP-UP AMOUNTS, AND OTHER PAYMENTS MADE TO THE COMPANY ARE STRICTLY NON-REFUNDABLE EXCEPT AS REQUIRED BY MANDATORY APPLICABLE LAW. NO REFUND, CREDIT, OR PRORATION WILL BE PROVIDED FOR: ANY FEES FOR A PARTIALLY USED BILLING PERIOD; UNUSED SUBSCRIPTION BENEFITS OR CREDITS; FEES FOR PERIODS DURING WHICH YOUR ACCOUNT WAS INACTIVE OR SUSPENDED; ANY UNUSED TOP-UP BALANCE; OR ANY FEES PAID IN ADVANCE REGARDLESS OF THE REASON FOR CANCELLATION OR TERMINATION.
You expressly acknowledge that the non-refundable nature of fees applies equally where the Company suspends or terminates your account at our sole discretion.
13.4  Fee Changes
We may, from time to time, make changes to subscription fees and will communicate any price changes to you in accordance with applicable law. Continued use of the Platform after a fee change takes effect constitutes your acceptance of the new fees.
13.5  Mandatory Consumer Rights
Nothing in these Terms affects any mandatory statutory rights you may have as a consumer under the laws of your country of residence, including under EU/EEA and Irish consumer law. If you are in the EU/EEA or the UK, you may have a right to withdraw from certain online purchases within 14 days, subject to conditions and exceptions. We will honour any such mandatory rights.


14. SUSPENSION AND TERMINATION
14.1  Company's Absolute Right to Suspend or Terminate
WE RESERVE THE RIGHT, AT ANY TIME AND IN OUR SOLE AND ABSOLUTE DISCRETION, WITH OR WITHOUT PRIOR NOTICE, AND WITHOUT ANY LIABILITY OR OBLIGATION WHATSOEVER TO YOU, TO SUSPEND, RESTRICT, OR TERMINATE YOUR ACCESS TO THE PLATFORM OR YOUR ACCOUNT OR MEMBERSHIP, INCLUDING ANY PAID SUBSCRIPTION, AT ANY STAGE OF YOUR SUBSCRIPTION TERM, FOR ANY REASON OR NO REASON.
14.2  No Refunds Upon Termination or Suspension by Us
...
Upon termination of your account, your right to use the Platform ceases immediately. We may delete or disable access to your User Content in accordance with applicable law and our data retention practices. Sections 1, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 16, 18, 19, and 20 shall survive termination.


15. FORCE MAJEURE
The Company shall not be liable for any failure or delay in performing its obligations under these Terms where such failure or delay results from any cause beyond the Company's reasonable control ('Force Majeure Event'), including without limitation: acts of God, natural disasters, or severe weather events; pandemic, epidemic, or public health emergency declared by a governmental authority; war, terrorism, riot, civil unrest, or acts of a public enemy; governmental or regulatory action, sanction, embargo, or change in law; failure or disruption of third-party infrastructure, including the internet, telecommunications networks, or power supply; failure or disruption of Stripe's systems, payment infrastructure, or banking partners; or any other event outside the Company's reasonable control.
In the event of a Force Majeure Event, the Company's obligations under these Terms shall be suspended for the duration of the Force Majeure Event. A Force Majeure Event affecting the Company does not affect users' obligations under these Terms, including payment obligations.
...
18. INDEMNIFICATION
You agree to indemnify, defend, and hold harmless the Company and its officers, directors, employees, contractors, and agents from and against any claims, demands, losses, damages, liabilities, costs, and expenses (including reasonable legal fees) arising out of or in connection with:
...
The laws of Ireland, excluding its conflict of laws rules, will govern these Terms and any dispute arising out of or relating to them, subject to any mandatory consumer protection rules in your country of residence. If you are a consumer in the EU/EEA or UK, you may benefit from additional rights under the laws of your country of residence and may be able to bring claims in your local courts.
...
Binding Arbitration
Any dispute arising from these Legal Terms shall be determined by one arbitrator chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration. The seat of arbitration shall be Ireland. Applicable rules of substantive law shall be the law of Ireland. Disputes involving Stripe's payment services are subject to the separate dispute resolution mechanism in the Stripe Services Agreement.
Restrictions on Arbitration
Any arbitration shall be limited to the dispute between the Parties individually. No class-action arbitration is permitted. No arbitration may be brought in a purported representative capacity on behalf of the general public or any other persons.
Limitation on Time to File Claims
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS OR THE PLATFORM MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES. IF YOU FAIL TO COMMENCE ANY SUCH ACTION WITHIN THIS PERIOD, SUCH CAUSE OF ACTION OR CLAIM IS PERMANENTLY BARRED. Nothing in this clause limits any shorter limitation period that may apply under applicable law, nor does it extend any mandatory limitation period that cannot be shortened.
Waiver of Jury Trial
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, EACH PARTY WAIVES ANY RIGHT TO A TRIAL BY JURY IN ANY ACTION, PROCEEDING, OR CLAIM ARISING OUT OF OR RELATING TO THESE TERMS OR THE PLATFORM. This waiver applies to the fullest extent permitted by law in the applicable jurisdiction and does not apply where prohibited by mandatory law.
Equitable Relief
...
You represent and warrant that: (a) you are not located in a country that is subject to a government embargo or that has been designated as a 'terrorist supporting' country by the relevant governmental authority; (b) you are not listed on any governmental list of prohibited, sanctioned, or restricted parties; and (c) you will not use the Platform, the Services, or any related technology in violation of any applicable export control or sanctions laws, including those of Ireland, the European Union, the United Kingdom, and the United States.
The Company reserves the right to suspend or terminate any account that it reasonably believes is in breach of this Section, without notice and without liability.
...
These Terms are for the benefit of the Parties only and do not create any rights enforceable by any third party, except as expressly stated otherwise in these Terms. Nothing in these Terms confers any benefit, right, or remedy on any person who is not a party to these Terms.
Relationship of the Parties
There is no joint venture, partnership, employment, franchise, or agency relationship created between you and the Company as a result of these Terms or your use of the Platform. Neither Party has the authority to bind the other or to incur any obligation on the other's behalf.
Headings
Section headings in these Terms are for convenience of reference only and have no legal effect on the interpretation of the relevant section.
Language
...
export default function TermsAndConditionsPage() {
  ...
  const content = TERMS_OF_SERVICE_CONTENT
