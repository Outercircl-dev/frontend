...
import { Settings, LogOut, User, Heart, MapPin } from 'lucide-react'
...
export default async function ProfilePage() {
  // Get profile using server action (which calls backend API)
  const { profile, error: profileError } = await getProfileAction()

  // If no profile or error, redirect to onboarding
  if (profileError || !profile) {
    console.warn('Profile: No profile found, redirecting to onboarding')
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Your profile data saved in the database.
                </p>
              </CardHeader>
